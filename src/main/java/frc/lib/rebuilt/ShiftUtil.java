...
import frc.lib.rebuilt.ShiftUtil.AutoWinOverrideState;
	...
	public static void publishShiftInfo() {
		...
		Color winningAllianceColor =
				switch (getFirstActiveAlliance()) {
					case Blue:
						yield RobotConstants.isRedAlliance ? Color.kLimeGreen : Color.kPurple;
					case Red:
						yield RobotConstants.isRedAlliance ? Color.kRed : Color.kLimeGreen;
					default:
						yield Color.kGray;
				};
