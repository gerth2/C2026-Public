...
public class TimestampedChassisSpeeds extends ChassisSpeeds {
	...
	public TimestampedChassisSpeeds(ChassisSpeeds speeds, double timestampSeconds) {
		this(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond, speeds.omegaRadiansPerSecond, timestampSeconds);
	}
	...
	public TimestampedChassisSpeeds(TimestampedChassisSpeeds speeds) {
		this(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond, speeds.omegaRadiansPerSecond, speeds.timestampSeconds);
	}
