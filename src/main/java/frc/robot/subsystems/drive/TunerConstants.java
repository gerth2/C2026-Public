...
public class TunerConstants {
	...
	private static final Slot0Configs driveGains = new Slot0Configs()
			.withKP(RobotConstants.isEpsilon ? 8.0 : 8.0)
			.withKI(RobotConstants.isEpsilon ? 0.0 : 0.0)
			.withKD(RobotConstants.isEpsilon ? 0.0 : 0.0)
			.withKS(RobotConstants.isEpsilon ? 0.0 : 0.0)
			.withKV(RobotConstants.isEpsilon ? 0.88 : 0.88);
	...
	public static final CANBus kCANBus = RobotConstants.canivore1;

	// Theoretical free speed (m/s) at 12 V applied output;
	// This needs to be tuned to your individual robot
	public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(RobotConstants.isEpsilon ? 4.39 : 4.39);

	// Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
	// This may need to be tuned to your individual robot
	private static final double kCoupleRatio = RobotConstants.isEpsilon ? 4.5 : 4.5;

	private static final double kDriveGearRatio = RobotConstants.isEpsilon ? 7.03125 : 7.03125;
	private static final double kSteerGearRatio = RobotConstants.isEpsilon ? 26.09090909090909 : 26.09090909090909;
	...
	private static final Angle kFrontLeftEncoderOffset =
			Rotations.of(RobotConstants.isEpsilon ? 0.405029296875 : 0.124267578125);
	...
	private static final Angle kFrontRightEncoderOffset =
			Rotations.of(RobotConstants.isEpsilon ? -0.441650390625 : 0.321533203125);
	...
	private static final Angle kBackLeftEncoderOffset =
			Rotations.of(RobotConstants.isEpsilon ? 0.122314453125 : 0.14404296875);
	...
	private static final Angle kBackRightEncoderOffset =
			Rotations.of(RobotConstants.isEpsilon ? -0.309326171875 : -0.340087890625);
