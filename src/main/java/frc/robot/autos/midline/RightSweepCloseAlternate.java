 ...
 */
public class RightSweepCloseAlternate extends AutoModeBase {

	AutoTrajectory startToLine = mirroredTrajectory("startToScoreClose");
	...
	public RightSweepCloseAlternate(AutoFactory factory) {
		super(factory, "Right Sweep Close Alternate");
