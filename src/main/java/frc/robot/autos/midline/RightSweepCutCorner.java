 ...
 */
public class RightSweepCutCorner extends AutoModeBase {
	AutoTrajectory leftStartToLine = mirroredTrajectory("startToCornerCut");
	...
	public RightSweepCutCorner(AutoFactory factory) {
