 ...
 */
public class LeftSweepCutCorner extends AutoModeBase {
	AutoTrajectory leftStartToLine = trajectory("startToCornerCut");
	AutoTrajectory scoreToSecondSweep = trajectory("scoreToSecondSweep");
	...
	public LeftSweepCutCorner(AutoFactory factory) {
		super(factory, "Left Sweep");
