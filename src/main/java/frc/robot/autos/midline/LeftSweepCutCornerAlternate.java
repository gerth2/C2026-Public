 ...
 */
public class LeftSweepCutCornerAlternate extends AutoModeBase {
	...
	public LeftSweepCutCornerAlternate(AutoFactory factory) {
		super(factory, "Left Sweep Cut Corner Alternate");
